...
`bash scripts/tomcat/run-war-smoke.sh --skip-build --war dist/MicrobeTrace_w.war --context ROOT`

`scripts/tomcat/run-war-smoke.cmd --skip-build --war dist\\MicrobeTrace_w.war --context ROOT`
