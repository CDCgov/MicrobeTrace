...
Companion QA tracker: `docs/dashboard-cypress-qa-tracker.csv`

Companion bug log: `docs/dashboard-cypress-bug-log.csv`
...
- [ ] Save a custom multi-pane dashboard layout and reload the `.microbetrace` session to verify round-trip restoration of the same tab set, active tab, and splitter arrangement.
...
- The maintained uploaded-data dashboard propagation coverage lives in `cypress/e2e/journeys/flows/dashboard-global-styling-uploaded.cy.ts`, `cypress/e2e/journeys/flows/dashboard-filtering-propagation-uploaded.cy.ts`, and `cypress/e2e/journeys/flows/dashboard-timeline-propagation-uploaded.cy.ts`.
