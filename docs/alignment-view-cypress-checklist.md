...
Companion QA tracker: `docs/alignment-view-cypress-qa-tracker.csv`

Companion bug log: `docs/alignment-view-cypress-bug-log.csv`
...
- Direct default-view launch to Alignment was fixed under `ABG001` in `docs/alignment-view-cypress-bug-log.csv`.
- The zero-value `Ruler Minor Interval` dropdown path was fixed under `ABG002` in `docs/alignment-view-cypress-bug-log.csv`.
