...
export class CommonService extends AppComponentBase implements OnInit {
    ...
    get linkThreshold(): number {
     ...
     setNetworkUpdated(newPruned: boolean): void {
      ...
      setSettingsLoaded(loaded: boolean): void {
          this._settingsLoaded$.next(loaded);
      }
    ...
    applySession(stashObject: StashObjects) {
        ...
        // TODO:: Do we need to show this right now?
...
align(params): Promise<any> {
  ...
  computeLinks(subset): Promise<any> {
    ...
    async finishUp() {
        ...
        console.log('----- finishUp called end - fully');
    ...
    updateNetworkVisuals(silent: boolean = false) {
        ...
        this.tagClusters().then(() => {
          ...
          this.setLinkVisibility(true);
          this.updateStatistics();
          if (!silent) this.setNetworkUpdated(true);
    ...
    createLinkColorMap() {
        ...
        console.log('---generate link color values: ', values);
        console.log('---generate link color aggregates: ', aggregates);
    ...
    */
    ...
    //     console.log('tag clusters called  updateNetwork');

    //     this.tagClusters().then(() => {
            
    //         this.setClusterVisibility(true);
    //         console.log('updateNetwork called 3');
